...
using WriteVTK
using Gridap
using Gridap: ThetaMethod, LUSolver, solve, TransientLinearFEOperator
using Random
using Gmsh
using GridapGmsh
...
# Créer un disque de rayon 1 centré en (0,0)
disk = gmsh.model.occ.addDisk(0.0, 0.0, 0.0, 1.0, 1.0)

# Synchroniser la géométrie
gmsh.model.occ.synchronize()

# Marquer la région physique (ici 2D : surface)
...
gmsh.write("demo/sphere.msh")
Gmsh.finalize()

order = 1
model = GmshDiscreteModel("demo/sphere.msh")
